...
var turnDiagramModule = new inversify_1.ContainerModule(function (bind, unbind, isBound, rebind) {
    ...
    var moduleFeatures = {
        disable: [sprotty_1.moveFeature],
        enable: [sprotty_1.openFeature, sprotty_1.expandFeature]
    };
    var labelFeatures = {
    ...
    sprotty_1.configureModelElement(context, 'turnnode:actor', turn_models_1.TURNNode, views_1.ModuleNodeView, moduleFeatures);
